        ...
        <div>
            ...
            {action === 'new' && (
                <form>
                    ...
                    <p className='text-grey-500 text-sm'>title for your place. should be short and catchy as in adverstisment</p>
                    <input type="text" placeholder="title, for example: My Lovely Appratment">
                    </input>
                    <h2 className='text-xl mt-4'>
                        Address
                    </h2>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <button className="bg-gray-200 w-40 rounded-2xl">Add&nbsp;photo</button>
                    </div>
                    <div className='grid grid-col-3 md:grid-cols-4 lg:grid-cols-6'>
                        <button className='flex justify-center p-8 text-2xl text-gray-600 mt-2 text-center border bg-transparent rounded-2xl'>
                    ...
                    <p className='text-grey-500 text-sm'>house rules, etc</p>
                    <textarea className='mt-2' />
                    <h2 className='text-xl mt-4'>
                        Check in&out times, Max guests
                    </h2>
                    <p className='text-grey-500 text-sm'>Add check in and out times, remember to have some time window for cleaning the room between guests</p>
